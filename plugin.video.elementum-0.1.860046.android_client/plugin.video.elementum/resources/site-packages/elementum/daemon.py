...
def start_elementumd(**kwargs):
    ...
    if hasSubprocess:
        ...
        xbmc.executebuiltin('StartAndroidActivity(service.elementum.android, android.intent.action.MAIN, , stop:0.1.860046)')
        repoAddonId = 'repository.elementum'
        serviceRepoAddonId = 'repository.service.elementum'
        repoAddonInfoFormat = "<addon name='{name}' id='{id}' provider-name='elgatito' version='0.1.860046'><extension name='{name}' point='xbmc.addon.repository'><dir><checksum>{dataDir}plugin.video.elementum/addons.xml.md5</checksum><datadir zip='true'>{dataDir}</datadir><info compressed='false'>{dataDir}plugin.video.elementum/addons.xml</info></dir></extension><extension point='xbmc.addon.metadata'><platform>all</platform><summary lang='en'>{summary}</summary></extension><requires></requires></addon>"
        ...
        xbmc.executebuiltin('StartAndroidActivity(service.elementum.android, android.intent.action.MAIN, , version:0.1.860046%s)' % dataSuffix)
